...
<div class="col-12 col-lg-3">
        ...
        <div class="card shadow-sm mb-4" >
            <div class="card-body">
                ...
                <br>
                <p class="card-text text-justify"> <span class="h6">Location: Kaduna</p>
                <br>
                <p class="card-text text-justify"> <span class="h6">Posted By: John Doe</p>
                <br>
                <p class="card-text text-justify"> <span class="h6">Amount: N00.00</p>
                <br>
        ...
        <div class="media-body">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 col-md-4 col-sm-4">
                    Tag Font Icon Here and Name
                </div>
                <div class="col-12 col-lg-4 col-md-4 col-sm-4">
                    Location Font Icon Here and location name
                </div>
                <div class="col-12 col-lg-4 col-md-4 col-sm-4">
